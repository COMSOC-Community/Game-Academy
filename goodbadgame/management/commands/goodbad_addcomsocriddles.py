...
def add_riddle_question(slug_prefix, title, question_text, alts_text):
    ...
    question, _ = Question.objects.update_or_create(
        slug=slug_prefix,
        defaults={"text": question_text, "title": title, "correct_alt": alt_objs[0]},
    )
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        add_riddle_question(
            "GaleShapley",
            "COMSOC Riddle 1",
            "What type of marriage are Gale and Shapley aiming for?",
        ...
        add_riddle_question(
            "NumberLinearOrders",
            "COMSOC Riddle 4",
            "How many ways are there to rank 4 alternatives in a linear order?",
            ["24", "4", "6", "16"],
        )
        add_riddle_question(
            "ApprovalVoting",
        ...
        add_riddle_question(
            "EnvyFreeness",
            "COMSOC Riddle 13",
            "Which of these is a fairness notion?",
        ...
        add_riddle_question(
            ...
            [
                ...
                "they are both submodular and supermodular",
